...
{
    public class DA_ConocimientoEmbarque
    {
        #region "Transaccion"
        ...
        {
            //  Finalidad               :   Listar las lineas navieras
            //  Entradas                :   Ninguna            
            //  Resultados              :   Una lista de tipo BE_LineaNaviera
            ...
            try
            {
                using (Database dbEtna = new Database())
                {
                    dbEtna.ProcedureName = "sps_Listar_LineaNaviera";                   
                    reader = dbEtna.GetDataReader();
                    List<BE_LineaNaviera> oBE_LineaNaviera = new List<BE_LineaNaviera>();
                    while (reader.Read())
                    {
                        oBE_LineaNaviera.Add(Pu_ConocimientoEmbarque.Publicar_LineaNaviera(reader));
                    }
                    reader.Close();
        ...
        {
            //  Finalidad               :   Listar los puertos
            //  Entradas                :   Ninguna            
            //  Resultados              :   Una lista de objetos de tipo BE_Puerto
            ...
            try
            {
                using (Database dbEtna = new Database())
                {
                    dbEtna.ProcedureName = "sps_Listar_Puerto";
                    reader = dbEtna.GetDataReader();
                    List<BE_Puerto> oBE_Puerto = new List<BE_Puerto>();
                    while (reader.Read())
                    {
                        oBE_Puerto.Add(Pu_ConocimientoEmbarque.Publicar_Puerto(reader));
                    }
                    reader.Close();
                    return oBE_Puerto;
                }
        ...
        public List<BE_TipoCarga> Listar_TipoCarga()
        {
            ...
            //  Finalidad               :   Listar Tipos de carga
            //  Entradas                :   Ninguna            
            //  Resultados              :   Una lista de objetos de tipo BE_TipoCarga
            ...
            try
            {
                using (Database dbEtna = new Database())
                {
                    dbEtna.ProcedureName = "sps_Listar_TipoCarga";
                    reader = dbEtna.GetDataReader();
                    List<BE_TipoCarga> oBE_TipoCarga = new List<BE_TipoCarga>();
                    while (reader.Read())
                    {
                        oBE_TipoCarga.Add(Pu_ConocimientoEmbarque.Publicar_TipoCarga(reader));
                    }
                    reader.Close();
